...
public class UserLoginSteps {
    ...
    public void an_unconnected_user_on_the_login_page(String username, String password) {
        exception = null;
        loggedInUser = null;
    ...
    @Given("an unconnected user on the login page with incorrect {string} and {string}")
    public void an_unconnected_user_on_the_login_page_with_incorrect_credentials(String username, String password) {
        exception = null;
        loggedInUser = null;
    ...
    public void the_user_is_redirected_to_their_homepage() {
        ...
        assertNull(exception, "Aucune exception ne doit être levée lors d'une connexion valide");
    }

    @Then("the user is shown an error message")
    public void the_user_is_shown_an_error_message() {
        assertNull(loggedInUser, "Aucun utilisateur ne doit être connecté si les identifiants sont invalides");
        assertNotNull(exception, "Une exception doit être levée pour une tentative de connexion invalide");
        assertInstanceOf(UnauthorizedException.class, exception, "L'exception doit être de type UnauthorizedException");
    }
